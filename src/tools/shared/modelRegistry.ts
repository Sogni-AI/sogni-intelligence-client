...
export const MODELS_BY_TOOL: Record<string, ModelOption[]> = {
  ...
  animate_photo: [
    ...
    { key: 'minimax-h3-fasth3-i2v-turbo-2stage', displayName: 'MiniMax H3 FastH3 Two-Stage (Image to Video)' },
    ...
    { key: 'minimax-h3-fasth3-flf2v-turbo-2stage', displayName: 'MiniMax H3 FastH3 Two-Stage (First + Last Frame)' },
    { key: 'wan3.0-video', displayName: 'Wan 3' },
    { key: 'wan3.0-spicy-video', displayName: 'Wan 3.0 Enhanced' },
  ],
  sound_to_video: [
