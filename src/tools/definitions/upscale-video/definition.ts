...
export const definition: ToolDefinition = {
  ...
  function: {
    ...
    description:
      ...
      'and the source can be at most about 1344x768 pixels (768x1344 in portrait). ' +
      'It must also be 1-60 fps and at most 100 MB. The server sets the maximum clip length and ' +
